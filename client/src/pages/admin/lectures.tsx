...
import {
  ArrowLeft, Plus, ChevronDown, ChevronRight, Video, Trash2, Pencil, Loader2, Layers, Play
} from "lucide-react";
...
export default function AdminLecturesPage({ courseId }: { courseId: string }) {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">Add a module above to organize your lectures</p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-3">
                  ...
                  <CollapsibleTrigger className="w-full">
                    <div className="flex items-center gap-3 p-4 text-left">
                      ...
                      <Button
                        ...
                        onClick={e => { e.stopPropagation(); setDeleteTarget({ type: "module", id: module.id, name: module.title }); }}
                        ...
                        {module.lectures.map((lecture) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {lecture.duration > 0 && (
                                <p className="text-xs text-muted-foreground">{formatDuration(lecture.duration)}</p>
                              )}
                            </div>
                            <div className="flex gap-1 flex-shrink-0">
                              ...
                              <Button
                                ...
                                variant="ghost"
                                className="h-7 w-7 text-destructive"
                                onClick={() => setDeleteTarget({ type: "lecture", id: lecture.id, name: lecture.title })}
      ...
      <Dialog open={lectureDialog.open} onOpenChange={open => !open && setLectureDialog({ open: false, moduleId: "" })}>
        <DialogContent>
          <DialogHeader>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setLectureDialog({ open: false, moduleId: "" })}>Cancel</Button>
            <Button
              onClick={() => saveLectureMutation.mutate()}
              disabled={!lectureTitle.trim() || saveLectureMutation.isPending}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {deleteTarget?.type === "module" && " All lectures inside will also be deleted."}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

...
export async function getUploadSignature(req: Request, res: Response) {
  if (!isCloudinaryConfigured) {
    return res.status(503).json({ message: "Cloudinary is not configured. Add CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET to your environment." });
  }
